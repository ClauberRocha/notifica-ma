...
import { FilePlus, List, LayoutDashboard, Users, LogOut, Sun, Moon } from "lucide-react";
    ...
    <div className="min-h-[80vh] flex flex-col justify-center">
      <div className="max-w-2xl mx-auto w-full px-2 py-8 relative">
        <button
          ...
          className="absolute right-2 top-2 h-9 w-9 inline-flex items-center justify-center rounded-md border border-border/80 bg-card text-foreground hover:bg-muted transition-colors"
        >
          {darkMode ? (
